...
impl CharBuffer {
    ...
    pub fn resize_and_clear(&mut self, size: impl Into<OffsetU16>, cell: Option<Cell>) {
...
impl<Idx: Into<OffsetU16>> Index<Idx> for CharBuffer {
...
impl<Idx: Into<OffsetU16>> IndexMut<Idx> for CharBuffer {
